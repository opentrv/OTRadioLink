...
{8,7,9,14, ALDataSample::NO_OCC_EXPECTATION, ALDataSample::NO_RD_EXPECTATION, ALDataSample::UNKNOWN_ACT_OCC, ALDataSample::SB_MINECO},  // Temporarily occupied: curtains drawn?  Borderline dark?  Reduced setback, anticipating occupancy?
{8,7,17,35},
{8,7,21,38},
...
// ...
{8,7,28,3, occType::OCC_NONE, true, false, ALDataSample::SB_NONEECO}, // Dark, vacant; reducing setback with antipicated occupancy.
...
// ...
{28,7,21,8},
{28,7,33,8, ALDataSample::NO_OCC_EXPECTATION, true, false, ALDataSample::SB_MINECO}, // Should be on reduced setback, anticipating occupancy.
...
{28,7,53,54, ALDataSample::NO_OCC_EXPECTATION, false, true}, // FIXME: should be able to detect curtains drawn here (occType::OCC_PROBABLE).
{28,8,0,69},
{28,8,12,85},
{28,8,16,90},
{28,8,24,103},
