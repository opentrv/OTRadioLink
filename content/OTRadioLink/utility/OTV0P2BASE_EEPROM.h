...
static const uint8_t *VOP2BASE_EE_START_16BYTE_PRIMARY_BUILDING_KEY = 112;
static const uint8_t VOP2BASE_EE_LEN_16BYTE_PRIMARY_BUILDING_KEY  = 16;


// Start area of radio config mem
static const uint8_t *V0P2BASE_EE_START_RADIO = 128; // INCLUSIVE START OF RADIO CONFIG AREA. // FIXME should this be a uint8_t? (technically a pointer to a 1 KiB eeprom)
static const uint8_t V0P2BASE_EE_LEN_RADIO  = 128; // SIZE OF RADIO CONFIG AREA.
static const uint8_t V0P2BASE_EE_END_RADIO  = 255;
...
static const uint8_t *V0P2BASE_EE_START_NODE_ASSOCIATIONS = 768; // Inclusive start of node associations
...
static const uint8_t *V0P2BASE_EE_END_NODE_ASSOCIATIONS = (V0P2BASE_EE_NODE_ASSOCIATIONS_MAX_SETS * V0P2BASE_EE_NODE_ASSOCIATIONS_SET_SIZE)-1; //
